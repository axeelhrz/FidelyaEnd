    ...
    <>
      ...
      >
        <div className="dashboard-container min-h-screen">
          ...
          <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-br from-amber-200/40 to-orange-200/40 rounded-full blur-xl animate-float-gentle"></div>
          <div className="absolute bottom-32 right-32 w-48 h-48 bg-gradient-to-br from-orange-200/30 to-amber-300/30 rounded-full blur-2xl animate-float-delay"></div>
          <div className="absolute top-1/2 left-10 w-24 h-24 bg-gradient-to-br from-amber-300/35 to-orange-300/35 rounded-full blur-lg animate-float"></div>
          <div className="absolute top-1/4 right-20 w-16 h-16 bg-gradient-to-br from-orange-400/40 to-amber-400/40 rounded-full blur-md animate-pulse-glow"></div>
          <div className="absolute bottom-1/4 left-1/3 w-20 h-20 bg-gradient-to-br from-amber-300/30 to-orange-400/30 rounded-full blur-lg animate-bounce-slow"></div>
          ...
          <div className="relative z-10 p-8 space-y-12">
            ...
            >
              <NotificationsCenter loading={authLoading} />
              <NotificationsCenter />
            </motion.div>
          </div>
        </div>
