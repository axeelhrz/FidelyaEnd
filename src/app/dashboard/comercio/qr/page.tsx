          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-lg text-gray-600 font-medium">
                Crea, personaliza y gestiona tu código QR para validaciones
              </p>
            </div>
              ...
              {activeTab === 'estadisticas' && (
                <div className="p-8">
                  ...
                  <div className="bg-gray-50 rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                      {[1, 2, 3, 4, 5].map((item) => (
                        <div key={item} className="flex items-center justify-between py-2 border-b border-gray-200 last:border-b-0">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Tu QR Code</h3>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-sm font-medium ${qrData ? 'text-green-600' : 'text-gray-400'}`}>
                    {qrData ? 'Generado' : 'No generado'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
